...
/* harmony import */ var _modules_expand_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/expand-content */ "./js/modules/expand-content.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_expand_content__WEBPACK_IMPORTED_MODULE_2__["expandContent"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["scrollToSection"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_mask__WEBPACK_IMPORTED_MODULE_6__["initPhoneMask"])();
    Object(_modules_validation__WEBPACK_IMPORTED_MODULE_7__["validateForm"])();
  });
});
...
function initAccordion() {
  var accBtns = document.querySelectorAll('.accordion__btn');
  var accBodys = document.querySelectorAll('.accordion__body');
  var listItems = document.querySelectorAll('.accordion__item');
  accBodys.forEach(function (item) {
    return item.classList.remove('no-js');
  });
  accBtns.forEach(function (item) {
    return item.classList.remove('no-js');
  });
  function setTabindex() {
    listItems.forEach(function (listItem) {
      return listItem.setAttribute('tabindex', '-1');
    });
  }
  function removeTabindex() {
    listItems.forEach(function (listItem) {
      return listItem.removeAttribute('tabindex');
    });
  }
  if (screen.width < 768) {
    setTabindex();
...
/*!**************************************!*\
  !*** ./js/modules/expand-content.js ***!
  \**************************************/
/*! exports provided: expandContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandContent", function() { return expandContent; });
var toggleButton = document.querySelector('.about-company__button');
var hiddenItem = document.querySelector('.about-company__wrapper');
...
var setPhoneMask = function setPhoneMask(e) {
  var el = e.target;
...
var modalContainer = document.querySelector('[data-modal="feedback"]');
var closeModalBtn = document.querySelector('[data-modal="close-modal"]');
var userName = document.getElementById('modal-input-name');
var body = document.getElementById('body');
var wrapper = document.getElementById('wrapper');
var INTERACTIVE_ELEMENTS = ['button', 'a', 'input', 'textarea', '[tabindex]'];
var interactiveElementsArr = wrapper.querySelectorAll(INTERACTIVE_ELEMENTS);
function openModal() {
  openModalBtn.addEventListener('click', function (e) {
    ...
    interactiveElementsArr.forEach(function (element) {
...
/*!******************************!*\
  !*** ./js/modules/scroll.js ***!
  \******************************/
/*! exports provided: scrollToSection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToSection", function() { return scrollToSection; });
var introButton = document.querySelector('.intro__button');
var introButtonNojs = document.querySelector('.intro__button-link');
...
var modalContainer = document.querySelector('[data-modal="feedback"]');
var username = modalContainer.querySelector('[name=username]');
var phone = modalContainer.querySelector('[name=phone]');
var modalForm = modalContainer.querySelector('#modal-form');
var checkbox = modalContainer.querySelector('#modal-agreement');
